import { Schematic, Net, Component, Pin } from "../src/puppycad";
...
export class TVSDiode extends Component {
    ...
    constructor() {
        super("TVSDiode");
        this.VIN = new Pin("VIN");
        this.VOUT = new Pin("VOUT");
...
export class BQ25703A extends Component {
    ...
    constructor() {
        super("BQ25703A");
        this.BAT = new Pin("BAT");
        this.IN = new Pin("IN");
        this.SYS = new Pin("SYS");
...
export class InductorL1 extends Component {
    ...
    constructor() {
        super("InductorL1");
        this.L1_IN = new Pin("L1_IN");
        this.L1_OUT = new Pin("L1_OUT");
...
export class ESP32_WROOM_32E extends Component {
    ...
    constructor() {
        ...
        this.V5_IN = new Pin("5V_IN");
        this.V33 = new Pin("3V3");
        this.GPIO21 = new Pin("GPIO21");
        this.GPIO22 = new Pin("GPIO22");
...
export class OV2640 extends Component {
    ...
    constructor() {
        super("OV2640");
        this.VCC = new Pin("VCC");
        this.SDA = new Pin("SDA");
        this.SCL = new Pin("SCL");
